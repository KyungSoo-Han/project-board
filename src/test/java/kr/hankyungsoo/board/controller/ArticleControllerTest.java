...
import kr.hankyungsoo.board.config.TestSecurityConfig;
...
import kr.hankyungsoo.board.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "hanksTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
